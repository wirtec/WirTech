...
class WirTechRadar:
    ...
    def batch_analyze_with_gemini(self, candidates_data):
        ...
        system_prompt = (
            ...
            "🎯 وظیفه تو تبدیل هر خبر خام انگلیسی به یک تیتر جذاب فارسی و چند نکته خلاصه ساده و روان است. "
            "نیازی به تحلیل، پیش‌بینی یا ارزیابی تأثیر خبر نیست؛ فقط باید بگویی «چه اتفاقی افتاده».\n\n"
            ...
            "۳. بخش summary باید ۲ تا ۳ نکته کوتاه، خبری و مشخص باشد (نه تحلیلی)؛ فقط واقعیت خبر را بگو.\n"
            "۴. تیتر (title_fa) باید کوتاه (حداکثر ۱۲ کلمه)، جذاب و غیرتکراری باشد.\n\n"
            ...
            '    "urgency": عدد بین 1 تا 10 (میزان اهمیت خبر برای قرارگیری در خبرنامه)\n'
            "  }\n"
            "]"
        )
